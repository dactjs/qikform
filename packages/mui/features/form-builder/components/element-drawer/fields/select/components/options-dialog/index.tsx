...
import { SelectOptionItem } from "../option-item";
import { SelectOptionItemOverlay } from "../option-item-overlay";

export interface SelectOptionsDialogProps extends DialogProps {
  field: SelectField;
}
...
export function SelectOptionsDialog({
  field,
  ...dialogProps
}: SelectOptionsDialogProps): React.ReactElement {
