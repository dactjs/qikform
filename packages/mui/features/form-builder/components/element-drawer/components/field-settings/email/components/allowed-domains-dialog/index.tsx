...
import { EmailAllowedDomainItem } from "../allowed-domain-item";
import { EmailAllowedDomainItemOverlay } from "../allowed-domain-item-overlay";

export interface EmailAllowedDomainsDialogProps extends DialogProps {
  field: EmailField;
}

export function EmailAllowedDomainsDialog({
  field,
  ...dialogProps
}: EmailAllowedDomainsDialogProps): React.ReactElement {
