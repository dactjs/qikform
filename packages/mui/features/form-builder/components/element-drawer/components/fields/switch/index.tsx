...
import type { Form, SwitchField } from "@qikform/core";
...
export interface SwitchFieldSettingsProps {
  field: SwitchField;
}

export function SwitchFieldSettings({
  field,
}: SwitchFieldSettingsProps): React.ReactElement {
